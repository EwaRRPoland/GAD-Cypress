...
// data - articles
import { article1Data } from '../../support/data/apiDataArticles';
import { article2Data } from '../../support/data/apiDataArticles';
import { article3Data } from '../../support/data/apiDataArticles';
...
it('response code should be 201 and should create article3', () => {
    ...
    // delete article1
it('response code should be 200 and should delete article1', () => {
    cy.request({
        method: 'DELETE',
        ...
        cy.request({
            ...
            cy.log('GET Response Status:', getStatus);
            cy.log('GET Response Body:', getResponse.body);
            assert.equal(getStatus, 404, 'Response status should be 404, indicating the article is not found');
        });
    });
});
    // delete article2
it('response code should be 200 and should delete article2', () => {
    cy.request({
        method: 'DELETE',
    ...
    // delete article3
it('response code should be 200 and should delete article3', () => {
    cy.request({
        method: 'DELETE',
