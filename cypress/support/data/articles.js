...
// articleNew1 - 300 chracters
export const titleNew1='XXX.';
export const bodyNew1 = 'XXXch ppppppppppppppppppppppsssssssssssssss.';
//export const user1='';
export const pictureNew1 = '56.jpg';
    
// articleNew2 - 400 characters
export const titleNew2='kkkkkkK.';
//export const user2='';
export const bodyNew2 = 'PPPPPPPPPPPPP';    
export const pictureNew2 = '12.jpg';

// articleNew3 - under 400 chracters
export const titleNew3='AOPopOPOP';
export const bodyNew3 = 'bgcygfEYHVE ';
//export const user3 = '';
export const pictureNew3 = '12.jpg';
